...
<body class="off-canvas-sidebar">
    ...
    <div class="wrapper wrapper-full-page">
        <div class="page-header register-page header-filter" filter-color="black"
            style="background-image: url('{{ asset('img/register.jpg') }}')">
            <div class="container">
                <div class="row">
                                        ...
                                        <form method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="form-group has-default">
                                                <div class="input-group">
                                                    ...
                                                    <input id="face" type="text" placeholder="クリエイター名"
                                                        class="form-control @error('face') is-invalid @enderror"
                                                        name="face" value="{{ old('face') }}" required
                                                        autocomplete="face">
                                            ...
                                            <div class="form-group has-default">
                                                <div class="input-group">
                                                    ...
                                                    <input id="jsat_navi_id" type="text" placeholder="JSAT NAVI ID"
                                                        class="form-control @error('jsat_navi_id') is-invalid @enderror"
                                                        name="jsat_navi_id" value="{{ old('jsat_navi_id') }}" required
                                                        autocomplete="jsat_navi_id">
